...
export const WorkstationShell: React.FC<WorkstationShellProps> = ({ children, isMobile }) => {
    ...
    const isLanding = location.pathname === '/' || location.pathname === '/testblandingpage' || location.pathname === '/terminal' || location.pathname === '/resonance' || location.pathname === '/tangle' || location.pathname === '/learning';
